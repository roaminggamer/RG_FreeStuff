-- WARNING!!! This file slightly modified from original MLText.
--
-- Search for 'EFM' to see functional change.
	...
	r_mltext = function( r_twords, group, r_params  )
		...
		for i = 1, #r_twords do
			...
			if(type(word) == "string") then
				--print("EDO", "::"..word.."::", r_params.font, r_params.fontSize)
