...
rooms['start'] = { title = 'Beach', 
	description = "You are standing on a beach.  A rocky trail leads #north#room1 towards some cliffs.  To the #west#room2 you see a shack.  " }

rooms['room1'] = { title = 'Cliffs', 
	description = "A small clearing rests at the base of impassible cliffs.  A rocky trail leads #south#start towards the ocean.  A grassy path leads uphill to the #west#room3.  " }
