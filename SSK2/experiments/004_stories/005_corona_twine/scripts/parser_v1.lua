...
public.gotoPage = function( pageName, oldPageGroup )
	return public.displayPage( story[pageName], oldPageGroup )
end

public.displayPage = function ( pageData, oldPageGroup )
