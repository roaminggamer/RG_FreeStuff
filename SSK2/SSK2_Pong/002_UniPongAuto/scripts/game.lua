...
function game.start( group, params )
	...
	-- Game label
	--
	local gameLabel = easyIFC:quickLabel( layers.interfaces, "002 UniPongAuto", bw.x, bw.y - 20, ssk.gameFont(), 20 )

	--
	-- Create the paddle
	--
	local function onEnterFrame( self )
		if( ball and self.isMoving ) then
	...
	ball = newImageRect( layers.content, left + 100, centerY, 
