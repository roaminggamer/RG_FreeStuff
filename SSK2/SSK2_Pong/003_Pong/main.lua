...
ssk.misc.easyAlert( "Choose Game Mode",
	        "Three modes supported.",
	        {
	        { "Two Player", function() game.start( nil, { debugEn = false, gameMode = 2 } ) end },
	        { "One Player", function() game.start( nil, { debugEn = false, gameMode = 1 } ) end },
	        { "Zero Player", function() game.start( nil, { debugEn = false, gameMode = 0 } ) end },
	        } )
