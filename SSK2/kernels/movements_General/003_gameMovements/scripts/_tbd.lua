...
function example.run( group )
	...
	--
	player = newImageRect( group, centerX, centerY - 50, "images/arrow.png", { size = 40 }, { radius = 20 } )
	...
	player.enterFrame = function( self )
		self:applyForce( (self.leftInput + self.rightInput) * self.mass, 0, self.x, self.y )
