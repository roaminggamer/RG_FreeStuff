...
function scene:create( event )
   ...
   local title = display.newText( sceneGroup, "actions.* Movements", centerX, top + 50, 
   ...
   newButton( "Face Instantly", "scripts.face_instantly" )
   newButton( "Face Over Time", "scripts.face_over_time" )
   newButton( "Thrust Forward", "scripts.thrust_forward" )
   newButton( "Limit Velocity", "scripts.limitv" )
   newButton( "Forward At Fixed Rate", "scripts.forward" )
   newButton( "Impulse Forward", "scripts.impulse_forward" )
