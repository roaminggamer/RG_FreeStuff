...
createPiece = function( x , y, size )
	...
	piece.label:setTextColor( 128,128,128,255 )
...
createBoard = function()
	...
	resetGameButton:setReferencePoint( display.CenterReferencePoint )
	...
	resetGameButtonText:setTextColor( 128,128,128,255 )
