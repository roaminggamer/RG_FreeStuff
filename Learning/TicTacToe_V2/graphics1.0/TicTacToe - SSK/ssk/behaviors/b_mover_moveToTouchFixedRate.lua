...
-- =============================================================
-- Behavior - Mover: Move to Touch at Fixed Rate
-- =============================================================
...
public = {}
public._behaviorName = "mover_moveToTouchFixedRate"
...
function public:onAttach( obj, params )
	...
	local moveSpeed = (params.moveSpeed or 250)
	local easing    = params.easing or easing.linear
	local moveObj   = obj
	...
	function behaviorInstance:touch( event )
		...
		elseif(event.phase == "ended" or event.phase == "cancelled") then
			ssk.component.transition_moveToObject( moveObj, event, moveSpeed, easing )
