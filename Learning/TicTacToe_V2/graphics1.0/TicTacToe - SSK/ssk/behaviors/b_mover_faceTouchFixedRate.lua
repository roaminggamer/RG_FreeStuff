...
-- =============================================================
-- Behavior - Mover: Face Touch At Fixed Rate
-- =============================================================
...
public = {}
public._behaviorName = "mover_faceTouchFixedRate"
...
function public:onAttach( obj, params )
	...
	local aimSpeed = (params.aimSpeed or 90)
	...
	function behaviorInstance:touch( event )
		...
		elseif(event.phase == "ended" or event.phase == "cancelled") then
			...
			ssk.component.transition_faceObject( moveObj, event, aimSpeed, easing )
