...
-- =============================================================
-- Virtual Horizontal Snap Input Test
-- =============================================================
...
function gameLogic:createScene( screenGroup )
	...
	ssk.gem:add("myHorizSnapEvent", horizSnapListener)

	ssk.inputs:createVirtualHorizontalSnap( centerX+140, centerY, 40, 140, 20, 10, "myHorizSnapEvent", backImage, screenGroup )
end
...
function gameLogic:destroyScene( screenGroup )
	...
	ssk.gem:remove("myHorizSnapEvent", horizSnapListener)
end
...
horizSnapListener = function( event )
	for k,v in ipairs( labelNames ) do
