...
-- =============================================================
-- Virtual Vertical Snap Input Test
-- =============================================================
...
function gameLogic:createScene( screenGroup )
	...
	ssk.inputs:createVirtualVerticalSnap( centerX+140, centerY, 40, 140, 20, 10, "myVertSnapEvent", backImage, screenGroup )
end
...
function gameLogic:destroyScene( screenGroup )
	...
	ssk.gem:remove("myJoystickEvent", vertSnapListener)
end
