...
function scene:createScene( event )
	...
	ssk.labels:quickLabel( layers.buttons, "'Classes' 1 of 3", centerX, 15, gameFont, 30, _YELLOW_ )

	ssk.labels:quickLabel( layers.buttons, "Buttons", w/4, 40, gameFont, 20 )
	ssk.labels:quickLabel( layers.buttons, "----------", w/4, 50, gameFont, 20 )

	ssk.buttons:presetPush( layers.buttons, "default", w/4, 75, 210, 30, "Push",  onDemo )
	ssk.buttons:presetPush( layers.buttons, "default", w/4, 110, 210, 30, "Radio",  onDemo )
	ssk.buttons:presetPush( layers.buttons, "default", w/4, 145, 210, 30, "Toggle",  onDemo )
	ssk.buttons:presetPush( layers.buttons, "default", w/4, 180, 210, 30, "Sliders",  onDemo )
	ssk.buttons:presetPush( layers.buttons, "default", w/4, 215, 210, 30, "Presets",  onDemo )
	ssk.buttons:presetPush( layers.buttons, "default", w/4, 250, 210, 30, "Standard Callbacks",  onDemo )

	ssk.labels:quickLabel( layers.buttons, "Labels", w-w/4, 40, gameFont, 20 )
	ssk.labels:quickLabel( layers.buttons, "----------", w-w/4, 50, gameFont, 20 )

	ssk.buttons:presetPush( layers.buttons, "default", w-w/4, 75, 210, 30, "Preset",  onDemo )
	ssk.buttons:presetPush( layers.buttons, "default", w-w/4, 110, 210, 30, "Quick",  onDemo )

	ssk.labels:quickLabel( layers.buttons, "(Virtual) Inputs", w-w/4, 180, gameFont, 20 )
	ssk.labels:quickLabel( layers.buttons, "-----------------", w-w/4, 190, gameFont, 20 )

	ssk.buttons:presetPush( layers.buttons, "default", w-w/4, 215, 210, 30, "Snap",  onDemo )
	ssk.buttons:presetPush( layers.buttons, "default", w-w/4, 250, 210, 30, "Joystick/DPad",  onDemo )
