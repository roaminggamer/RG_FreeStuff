...
function scene:createScene( event )
	...
	ssk.labels:quickLabel( layers.buttons, "Goodies", centerX, 25, gameFont, 30, _YELLOW_ )
	
	ssk.buttons:presetPush( layers.buttons, "default", centerX, 80, 210, 30, "The Sampler",  nil, { textColor = _PINK_ } )
	ssk.buttons:presetPush( layers.buttons, "default", centerX, 120, 210, 30, "The Frames",  nil, { textColor = _PINK_ } )
	ssk.buttons:presetPush( layers.buttons, "default", centerX, 160, 210, 30, "Preset Packs",  nil, { textColor = _PINK_ } )
	ssk.buttons:presetPush( layers.buttons, "default", centerX, 200, 210, 30, "Resources",  nil, { textColor = _PINK_ } )
	ssk.buttons:presetPush( layers.buttons, "default", centerX, 240, 210, 30, "Bonus", nil, { textColor = _PINK_ } )
