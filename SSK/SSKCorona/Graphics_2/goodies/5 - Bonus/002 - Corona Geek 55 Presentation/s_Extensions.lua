...
function scene:createScene( event )
	...
	ssk.labels:quickLabel( layers.buttons, "Extensions", centerX, 25, gameFont, 30, _YELLOW_ )
	
	ssk.buttons:presetPush( layers.buttons, "default", centerX, 80, 210, 30, "io", onDemo )
	ssk.buttons:presetPush( layers.buttons, "default", centerX, 120, 210, 30, "math", onDemo )
	ssk.buttons:presetPush( layers.buttons, "default", centerX, 160, 210, 30, "string", onDemo )
	ssk.buttons:presetPush( layers.buttons, "default", centerX, 200, 210, 30, "table", onDemo )
	ssk.buttons:presetPush( layers.buttons, "default", centerX, 240, 210, 30, "timer", nil, { textColor = _PINK_ } )
	ssk.buttons:presetPush( layers.buttons, "default", centerX, 280, 210, 30, "transition", onDemo )
