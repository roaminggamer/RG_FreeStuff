...
--EFM G2	theHUD:setReferencePoint(display.CenterReferencePoint)
	theHUD.x, theHUD.y = x,y
...
--EFM G2	hud.leftBack:setReferencePoint( display.CenterRightReferencePoint )
...
--EFM G2	hud.leftDial:setReferencePoint( display.CenterRightReferencePoint )
...
--EFM G2	hud.rightBack:setReferencePoint( display.CenterLeftReferencePoint )
...
--EFM G2	hud.rightDial:setReferencePoint( display.CenterLeftReferencePoint )
...
--EFM G2		hud.overlay:setReferencePoint( display.CenterReferencePoint )
	...
	if(text) then
		...
		hud.label:setFillColor( unpack( textColor ) )
--EFM G2		hud.label:setReferencePoint( display.CenterReferencePoint )
		hud.label.x = size/2
		hud.label.y = size/2

	end

--EFM G2	hud:setReferencePoint( display.CenterReferencePoint )
	hud.x,hud.y = x,y
...
--EFM G2			self.label:setReferencePoint( display.CenterReferencePoint )
			self.label.x = size/2
			self.label.y = size/2
		end
...
--EFM G2	hud.spacer:setReferencePoint( display.CenterReferencePoint )
	hud.spacer.x = 0
	hud.spacer.y = 0
	hud.spacer:setFillColor( unpack(_TRANSPARENT_) )

	hud.backBar    = display.newRect(barGroup, 0,0,width,height)
--EFM G2	hud.backBar:setReferencePoint( display.CenterReferencePoint )
	hud.backBar:setFillColor( unpack(backSrc) )
	hud.backBar.x = 0		
	hud.backBar.y = 0

	hud.frontBar = display.newRect(barGroup, 0,0,width,height)
--EFM G2	hud.frontBar:setReferencePoint( display.CenterReferencePoint )
...
--EFM G2		hud.underlay:setReferencePoint( display.CenterReferencePoint )
		hud.underlay.x = 0
		hud.underlay.y = 0
	end

	hud.imageBar = display.newImageRect(hud, barSrc, width, height)
--EFM G2	hud.imageBar:setReferencePoint( display.CenterReferencePoint )
