...
createButtons = function ( )
	...
	for i = 0, #presetNames-1 do
		...
		tmpButton = ssk.buttons:presetToggle( layers.content, presetNames[presetNum], buttonX, buttonY, buttonWidth, buttonHeight, 
	...
	tmpButton = ssk.buttons:presetToggle( layers.content, "mpButton", buttonX, buttonY, 50, 50, "", pbCB )	

	-- Options
	buttonX = centerX + 50
	buttonY = screenBot - 50
	tmpButton = ssk.buttons:presetToggle( layers.content, "optionsButton", buttonX, buttonY, 50, 50, "", pbCB )	
