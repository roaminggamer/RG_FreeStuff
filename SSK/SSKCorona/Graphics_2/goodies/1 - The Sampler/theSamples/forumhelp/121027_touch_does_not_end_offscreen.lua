...
--EFM G2	gridGroup:setReferencePoint(display.CenterReferencePoint)
...
--EFM G2		text:setReferencePoint(display.CenterReferencePoint)
...
--EFM G2	legendGroup:setReferencePoint(display.CenterReferencePoint)
