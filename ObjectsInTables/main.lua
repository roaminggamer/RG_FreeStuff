...
for i = 1, 10000 do
	...
	-- Store references using indexed
	myObjects[i] = tmp
end
...
local t3 = bench.measureTime(pairsIteration_noWork,10)
local t4 = bench.measureTime(numericIteration_withWork,10)
local t5 = bench.measureTime(numericIterationWithNilTest_withWork,10)
local t6 = bench.measureTime(pairsIteration_withWork,10)


print("'#' iteration + No Work              x 10 iterations: " .. t1 .. " ms ")
print("'#' iteration + 'nil' Test + No Work x 10 iterations: " .. t2 .. " ms ")
print("'pairs() iteration + No Work         x 10 iterations: " .. t3 .. " ms ")

print("'#' iteration + Work                 x 10 iterations: " .. t4 .. " ms ")
print("'#' iteration + 'nil' Test + Work    x 10 iterations: " .. t5 .. " ms ")
print("'pairs() iteration + Work            x 10 iterations: " .. t6 .. " ms ")
