...
easy.allColors = {}
easy._TRANSPARENT_ 		= { 0, 0, 0, 0 } 
easy._WHITE_ 			= { 1, 1, 1, 1 }; easy.allColors[#easy.allColors+1] = easy._WHITE_
easy._BLACK_ 			= { 0, 0, 0, 1}; easy.allColors[#easy.allColors+1] = easy._BLACK_
easy._GREY_      		= {0.5, 0.5, 0.5, 1}; easy.allColors[#easy.allColors+1] = easy._GREY_
easy._DARKGREY_  		= { 0.25,  0.25,  0.25, 1}; easy.allColors[#easy.allColors+1] = easy._DARKGREY_
easy._DARKERGREY_  		= { 0.125,  0.125,  0.125, 1}; easy.allColors[#easy.allColors+1] = easy._DARKERGREY_
easy._LIGHTGREY_ 		= { 0.753, 0.753, 0.753, 1}; easy.allColors[#easy.allColors+1] = easy._LIGHTGREY_
easy._RED_   			= { 1, 0, 0, 1 }; easy.allColors[#easy.allColors+1] = easy._RED_
easy._GREEN_ 			= { 0, 1, 0, 1 }; easy.allColors[#easy.allColors+1] = easy._GREEN_
easy._BLUE_  			= { 0, 0, 1, 1 }; easy.allColors[#easy.allColors+1] = easy._BLUE_
easy._CYAN_  			= { 0, 1, 1, 1 }; easy.allColors[#easy.allColors+1] = easy._CYAN_
easy._YELLOW_       	= { 1, 1, 0, 1 }; easy.allColors[#easy.allColors+1] = easy._YELLOW_
easy._ORANGE_       	= { 1, 0.398, 0, 1 }; easy.allColors[#easy.allColors+1] = easy._ORANGE_
easy._BRIGHTORANGE_ 	= { 1, 0.598, 0, 1 }; easy.allColors[#easy.allColors+1] = easy._BRIGHTORANGE_
easy._PURPLE_       	= { 0.625, 0.125, 0.938, 1 }; easy.allColors[#easy.allColors+1] = easy._PURPLE_
easy._PINK_         	= { 1, 0.430, 0.777, 1 }; easy.allColors[#easy.allColors+1] = easy._PINK_

-- Short Names
easy._T_ 	= easy._TRANSPARENT_
easy._W_ 	= easy._WHITE_
easy._K_ 	= easy._BLACK_
easy._R_  	= easy._RED_
easy._G_ 	= easy._GREEN_
easy._B_  	= easy._BLUE_
easy._Y_  	= easy._YELLOW_
easy._O_  	= easy._ORANGE_
easy._P_  	= easy._PINK_
easy._C_  	= easy._CYAN_
...
-- ==
local lastColor
function easy.randomColor( )
   local curColor = easy.allColors[mRand(1, #easy.allColors)]
   while(curColor == lastColor) do
      curColor = easy.allColors[mRand(1, #easy.allColors)]
   end
   lastColor = curColor
   return curColor
end
...
-- ==
--    ssk.colors.easy.export() - Export basic colors into global space for even easier access to them.
-- ==
function colors.export()
	_G._T_ 	= easy._TRANSPARENT_
	_G._W_ 	= easy._WHITE_
	_G._K_ 	= easy._BLACK_
	_G._R_  = easy._RED_
	_G._G_ 	= easy._GREEN_
	_G._B_  = easy._BLUE_
	_G._Y_  = easy._YELLOW_
	_G._O_  = easy._ORANGE_
	_G._P_  = easy._PINK_
	_G._C_  = easy._CYAN_

	_G._TRANSPARENT_ 	= easy._TRANSPARENT_
	_G._WHITE_ 			= easy._WHITE_
	_G._BLACK_ 			= easy._BLACK_
	_G._RED_  			= easy._RED_
	_G._GREEN_ 			= easy._GREEN_
	_G._BLUE_  			= easy._BLUE_
	_G._YELLOW_  		= easy._YELLOW_
	_G._ORANGE_  		= easy._ORANGE_
	_G._BRIGHTORANGE_ = easy._BRIGHTORANGE_
	_G._PURPLE_ 		= easy._PURPLE_
	_G._PINK_  			= easy._PINK_
	_G._CYAN_  			= easy._CYAN_
	
	_G._GREY_  			= easy._GREY_
	_G._DARKGREY_  		= easy._DARKGREY_
	_G._DARKERGREY_  	= easy._DARKERGREY_
	_G._LIGHTGREY_  	= easy._LIGHTGREY_

	_G.randomColor  	= easy.randomColor

	_G.hexcolor  		= colors.hexcolor
end
...
-- ==
--    ssk.colors.hexcolor(  ) - converts hex color codes to rgba Graphics 2.0 value
-- ==
function colors.hexcolor( code )
