...
local ball = display.newCircle( centerX - fullw/2 + 100, centerY - 65, 20 )
...
local pusher = display.newRect( ball.x - 80, ball.y, 40, 40 )
...
local ball = display.newCircle( centerX - fullw/2 + 100, centerY +fullh/2 - 65, 20 )
physics.addBody( ball, "dynamic", { friction = 1, bounce = 0.2, radius = 20 } )
ball.fill = { type = "image", filename = "checkerboard.png" }
ball:setFillColor(1,1,0)
ball.linerDamping = 1
