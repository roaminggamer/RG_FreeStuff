...
function scene:create( event )
   ...
   ssk.easyIFC:presetPush( sceneGroup, "default", centerX, centerY - 100, 300, 60, "The Problem", onTest1 )

   ssk.easyIFC:presetPush( sceneGroup, "default", centerX, centerY, 300, 60, "Native Activity Indicator", onTest2 )

   ssk.easyIFC:presetPush( sceneGroup, "default", centerX, centerY + 100, 300, 60, "Split Loader", onTest3 )
...
onTest1 = function( event )
   composer.showOverlay( "scene1", { time = 500, isModal = true, effect = "slideRight", params = params } )
end
...
onTest3 = function( event )
   composer.showOverlay( "scene3", { time = 500, isModal = true, effect = "slideRight", params = params } )
end
