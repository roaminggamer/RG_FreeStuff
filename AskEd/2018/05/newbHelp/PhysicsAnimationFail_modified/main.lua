...
local sheetIdleKnight = graphics.newImageSheet( "assets/spritesheet/knightIdle.png", sheetOptionsIdle )
...
local sheetJumpKnight = graphics.newImageSheet( "assets/spritesheet/knightRunning.png", sheetOptionsJump )
...
local sheetWalkKnight = graphics.newImageSheet( "assets/spritesheet/knightWalking.png", sheetOptionsWalk )
...
knight.id = "knight"
--[[ BODY IS RECT; No good for this sprite 
...
physics.addBody( knight, "dynamic", { 
    ...
    friction = 0.5, 
    bounce = 0.3 ,
    radius = knight.contentWidth/2 - 10,
    } )
...
--Runtime:addEventListener( "enterFrame", checkCharacterPosition ) -- checkCharacterPosition NOT DEFINED ANYWHERE? 
--Runtime:addEventListener( "enterFrame", checkPlayerBulletsOutOfBounds ) -- checkPlayerBulletsOutOfBounds NOT DEFINED ANYWHERE? 
--Runtime:addEventListener( "collision", onCollision ) -- onCollision NOT DEFINED ANYWHERE? 
