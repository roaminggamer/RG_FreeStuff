...
function public.create_fps( allowDrag )
	...
	local centerX = fpsMeter.back.x + fpsMeter.back.contentWidth/2
	local centerY = fpsMeter.back.y + fpsMeter.back.contentHeight/2
	fpsMeter.label = display.newText(fpsMeter, "initializing...", centerX, centerY, native.systemFont, 12 )
