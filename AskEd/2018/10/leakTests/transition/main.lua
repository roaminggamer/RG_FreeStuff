...
moveRight = function( self )
	...
	--
	self.onComplete = moveLeft
	transition.to( self, { x = right, time = moveTime, onComplete = self } )
end
...
moveLeft = function( self )
	...
	--
	self.onComplete = moveRight
	transition.to( self, { x = left, time = moveTime, onComplete = self } )
end
