...
function scene:create( event )
   ...
   scene.rect1 = display.newRect( sceneGroup, display.contentCenterX, display.contentCenterY - 200, 180, 180 )
...
function scene:didShow( event )
   ...
   from = params.from
   scene.rect2:setFillColor( 1, 0, 1 )
   from.rect2:setFillColor( 1, 1, 0 )
end
...
onTouch = function( event )
   ...
   composer.hideOverlay( false, "slideLeft", 400 )
end
