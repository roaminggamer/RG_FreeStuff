...
-- =============================================================
local mAbs,mRand,mDeg,mRad,mCos,mSin,mAcos,mAsin,mSqrt,mCeil,mFloor,mAtan2,mPi,mMin,mMax,getInfo,getTimer,strMatch,strFormat,pairs;ssk.al.run()
...
-- 
-- local mRand,getTimer;ssk.al.run()
