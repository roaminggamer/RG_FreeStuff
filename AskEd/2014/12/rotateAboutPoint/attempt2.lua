...
local function rotateAbout( obj, x, y, params )	
	...
	transition.to( obj, { delay = 0 * qt, time = qt, x = x + radius, transition = easing.outCirc } )
	transition.to( obj, { delay = 1 * qt, time = qt, x = x, transition = easing.inCirc } )
	transition.to( obj, { delay = 2 * qt, time = qt, x = x - radius, transition = easing.outCirc } )
	transition.to( obj, { delay = 3 * qt, time = qt, x = x, transition = easing.inCirc } )
