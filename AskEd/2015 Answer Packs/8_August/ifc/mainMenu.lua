...
local answers = 
{
	{ "instantReplay", 					true, false, "http://forums.coronalabs.com/topic/58349-instant-replay-rewinding-physics-animation-on-multiple-objects", "GET_LINK" },
	{ "oneWayPlatform", 				true, false, "http://forums.coronalabs.com/topic/58356-passable-platforms-for-multiplayer-game", "GET_LINK" },
	{ "paths", 							false, false, "http://forums.coronalabs.com/topic/58374-how-to-move-an-object-in-a-path-endlessly", "GET_LINK" },
	{ "movingAntenna", 					true, false, "http://forums.coronalabs.com/topic/58384-moving-antenna-and-driver-in-car", "GET_LINK" },
	{ "secureStorage", 					true, false, "http://forums.coronalabs.com/topic/58414-how-safe-are-credentials-within-the-app", "GET_LINK" },
	{ "parabolicTransition", 			false, false, "http://forums.coronalabs.com/topic/58442-parabolic-motion-to-throw-objects", "GET_LINK" },
	{ "impulsesForcesVelocitiesOhMy", 	false, false, "http://forums.coronalabs.com/topic/58795-applyforce-problem", "GET_LINK" },
	{ "timeSpentPlaying",				true, false, "http://forums.coronalabs.com/topic/58759-calculating-time-played", "GET_LINK" },
	{ "rotateHandle", 					false, false, "http://forums.coronalabs.com/topic/58735-can-i-use-physics-to-do-this", "GET_LINK" },
	{ "tiltBall", 						false, false, "http://forums.coronalabs.com/topic/58706-how-do-i-tilt-a-ball-round-the-screen", "GET_LINK" },
	{ "homework",						true, false, "http://forums.coronalabs.com/topic/58459-help-with-falling-and-collision", "GET_LINK" },
	{ "homework", 						true, false, "http://forums.coronalabs.com/topic/58493-help-creating-code", "GET_LINK" },
	{ "homework", 						true, false, "http://forums.coronalabs.com/topic/58494-falling-objects-from-all-corners-that-go-towards-center-then-stop", "GET_LINK" },
}
