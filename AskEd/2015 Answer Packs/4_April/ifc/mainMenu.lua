...
local answers = 
{
	{ "skyForceMovement", 		true, false, "http://forums.coronalabs.com/topic/55988-help-needed-more-natural-drag-to-move-controls", "GET_LINK" },
	{ "fireBullet", 			true, false, "http://forums.coronalabs.com/topic/56016-problem-with-transitionto-and-physics", "GET_LINK" },
	{ "simpleMenu", 			false, false, "http://forums.coronalabs.com/topic/56046-making-a-menu", "GET_LINK" },
	{ "textTransitions", 		false, false, "http://forums.coronalabs.com/topic/56391-add-transition-to-a-text", "GET_LINK" },
	{ "taggingObjects", 		false, false, "http://forums.coronalabs.com/topic/56394-hundreds-of-dynamic-images-with-one-tap-listener-how-to-get-tagged-data", "GET_LINK" },
	{ "pickupKeys", 			false, false, "http://forums.coronalabs.com/topic/56434-lock-and-key", "GET_LINK" },
	{ "edgeDestruct", 			true, false, "http://forums.coronalabs.com/topic/56442-how-to-destroy-object-when-it-hits-edge-of-screen", "GET_LINK" },
	{ "rotateHandle", 			false, false, "http://forums.coronalabs.com/topic/56511-rotate-toward-certain-side-of-screen", "GET_LINK" },
	{ "bouncyBullets", 			true, false, "http://forums.coronalabs.com/topic/56529-why-bullet-object-is-not-bouncing-off-walls-at-proper-angle", "GET_LINK" },
	{ "projectileTrails", 		true, false, "http://forums.coronalabs.com/topic/56536-super-cool-missile-trails", "GET_LINK" },
	{ "simpleVoiceRecorder", 	false, false, "http://forums.coronalabs.com/topic/56537-how-to-code-a-voice-recorder-using-corona", "GET_LINK" },
	{ "bulletHell", 			true, false, "http://forums.coronalabs.com/topic/56166-is-corona-sdk-suitable-for-bullet-hells", "GET_LINK" },
