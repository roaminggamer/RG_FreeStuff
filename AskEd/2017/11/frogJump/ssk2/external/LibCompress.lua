	...
	timer.performWithDelay( 1,
		function() 
			for i = 1, select("#",arg) do
				tables_to_clean[(select(i,arg))] = true
			end
		end )
end
...
function LibCompress:CompressLZW(uncompressed)
	if type(uncompressed) == "string" then
		...
		print( #uncompressed, resize)
		
		if (#uncompressed + 1) > resize then
...
--	[3] = LibCompress.CompressHuffman
	[1] = LibCompress.CompressLZW,
	[1] = LibCompress.CompressHuffman
}
