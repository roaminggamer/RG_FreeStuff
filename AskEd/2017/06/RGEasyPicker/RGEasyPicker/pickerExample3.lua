...
local public = {}
local notes = {
	"This is a simple picker using images instead of text.",
	"",
...
local imagesList = {
	"images/danc/boy.png",
	"images/danc/bug.png",
	"images/danc/bush.png",
	"images/danc/gem.png",
	"images/danc/girl.png",
	"images/danc/heart.png",
	"images/danc/key.png",
	"images/danc/star.png",	
}
...
function public.drawExample( parentGroup )
	...
	local picker = newPicker( parentGroup, centerX, centerY, 240, 120, imagesList, onSpin )
	onSpin( picker )
end
