...
function scene:create( event )
	...
	PushButton( sceneGroup, centerX, centerY, "Blocking", onBlocking, { labelColor = {0,1,0}, labelSize = 24 } )

	PushButton( sceneGroup, centerX, centerY + 100, "Non-Blocking", onNonBlocking, { labelColor = {0,1,1}, labelSize = 24 } )
...
----------------------------------------------------------------------
onBlocking = function ( self, event ) 
	local options =
	{
	...
	composer.gotoScene( "ifc.blockingTest", options  )	
	return true
end

onNonBlocking = function ( self, event ) 
	local options =
	{
		effect = "fromBottom", -- See list here: http://docs.coronalabs.com/daily/api/library/composer/gotoScene.html
		time = 500,
	...
	composer.gotoScene( "ifc.nonBlockingTest", options  )	
	return true
end
