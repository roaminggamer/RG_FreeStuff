...
function tests.folderRoots( group, startY )
   ...
   local function doPathButton( myPathName, myPath, y )
      local label1 = easyIFC:quickLabel( group, "Folder Roots Test : " .. myPathName, left + 10, 0, gameFont, 16, _W_, 0 )
      local label2 = easyIFC:quickLabel( group, "  => " .. myPath, left + 10, 0, gameFont, 22, _W_, 0 )
      ...
      if( onDevice ) then button:disable()  end
   ...
   if( onDesktop or onSimulator ) then
...
function tests.foldersTest( group, startY, testFoldername )
   ...
   local function doPathButton( myPathName, baseFoldername , y )
      ...
      local label1 = easyIFC:quickLabel( group, "Folders Test : " .. myPathName, left + 10, 0, gameFont, 16, _W_, 0 )
      local label2 = easyIFC:quickLabel( group, "  => " .. foldername, left + 10, 0, gameFont, 22, _W_, 0 )
      if( label2.contentWidth > (fullw + 20)) then
         local scale = (fullw-20)/label2.contentWidth
         label2:scale(scale,scale)
      end
...
function tests.filesTest( group, startY, testFoldername, testFilename )
   ...
   local function doPathButton( myPathName, folder, baseFilename , y )
      ...
      local label1 = easyIFC:quickLabel( group, "Files Test : " .. myPathName, left + 10, 0, gameFont, 16, _W_, 0 )
      local label2 = easyIFC:quickLabel( group, "  => " .. filename, left + 10, 0, gameFont, 22, _W_, 0 )
      if( label2.contentWidth > (fullw + 20)) then
         local scale = (fullw-20)/label2.contentWidth
         label2:scale(scale,scale)
      end
...
function tests.mkFoldersTest( group, startY, testFoldername )
   ...
   local function doPathButton( myPathName, myPath, y )
      local label1 = easyIFC:quickLabel( group, "Make Folders Test : " .. myPathName, left + 10, 0, gameFont, 16, _W_, 0 )
      local label2 = easyIFC:quickLabel( group, "  => " .. myPath, left + 10, 0, gameFont, 22, _W_, 0 )
      if( label2.contentWidth > (fullw + 20)) then
         local scale = (fullw-20)/label2.contentWidth
         label2:scale(scale,scale)
   ...
   --local label1 = easyIFC:quickLabel( group, "Folder Roots:", left + 10, top + y + 0 * 30, gameFont, 16, _W_, 0 )
   --startY = startY + 
