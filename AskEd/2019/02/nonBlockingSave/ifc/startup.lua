...
function scene:create( event )
	...
	local label = display.newEmbossedText( sceneGroup, "Starting", centerX, centerY, native.systemFont, 60 )
	...
	-- Wait 1 frame, then generate big table of random data.
	local lorem = ssk.misc.getLorem( 80 )
