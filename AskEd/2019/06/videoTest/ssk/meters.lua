...
function public.create_fps( allowDrag )
	...
	fpsMeter.back = display.newRect( fpsMeter, left + 2, top + 2, 400, 50 )
	...
	fpsMeter.label = display.newText(fpsMeter, "initializing...", cx, cy, native.systemFont, 24 )
	...
	fpsMeter.enterFrame = function(self)
		...
		if( _G.beerCount ) then
			fpsMeter.label.text = fpsMeter.label.text .. "  --  BeerCount: " .. tostring(_G.beerCount)
		end
