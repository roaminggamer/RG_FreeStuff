...
-- Replacement for 'native.setKeyboardFocus' to handle faked input
         ...
         function easyTextField.create( group, x, y, width, height, params   )
            ...
            local unselStroke 		= params.unselStroke or color._RED_
            ...
            if( onWin ) then
               ...
               textField:setStrokeColor( unpack(unselStroke) )
...
----------------------------------------------------------------------
         if( _G.ssk ) then
            ssk.RGEasyTextField = easyTextField
         else 
            _G.ssk = { RGEasyTextField = easyTextField }
            _G.ssk = { RGEasyTextField = easyTextField }
         end
