...
function ccmgr:newCalculator()
	...
	function collisionsCalculator:dump()
		...
		for colliderName, colliderNum in pairs(self._colliderNum) do
			print(rpad(colliderName,15,SPC) .. "| ".. 
		      	rpad(tostring(colliderNum),4,SPC) .. "| ".. 
			  	rpad(tostring(self._colliderCategoryBits[colliderName]),9,SPC) .. "| ".. 
			  	rpad(tostring(self._colliderMaskBits[colliderName]),8,SPC))
		end
