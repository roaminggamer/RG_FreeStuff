...
--EFM G2	labelText:setReferencePoint( display.CenterReferencePoint )
	...
	-- ==
	function buttonInstance:setText( labelText ) 
		...
		--print( "buttonInstance:setText() self.labelText == " .. tostring(self.labelText) )
		
--EFM G2		labelText:setReferencePoint( display.CenterReferencePoint )
		labelText.x = self.labelOffset[1]
		labelText.y = self.labelOffset[2]
	end
	...
	-- ==
	function buttonInstance:getTextColor( labelText ) 
		local labelText = self.labelText
	...
	function buttonInstance:setFillColor( color ) 
		local labelText = self.labelText
		labelText:setFillColor( unpack( color ) )
	...
	function buttonInstance:setHighlight( vis )	
		...
		if(self.highlighted == nil or self.highlighted ~= vis) then
			...
			if(self.selLabelColor) then 
				if(vis) then		
					self.labelText:setFillColor( unpack( self.selLabelColor ) )
				else
					self.labelText:setFillColor( unpack( self.labelColor ) )
				end
			end

			if(self.selText and vis == true) then
				self.labelText.text = self.selText
			elseif(self.unselText and vis == false) then
				self.labelText.text = self.unselText 
			end
